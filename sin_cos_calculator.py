...
print(f"A {x} szinusza:   {sin} - hiba: {abs(math.sin(x)-sin)} Math fügvénnyel: {math.sin(x)}")
print(f"A {x} koszinusza: {cos} - hiba: {abs(math.cos(x)-cos)} Math fügvénnyel: {math.cos(x)}")
